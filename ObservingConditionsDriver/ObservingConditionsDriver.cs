...
//
// ASCOM ObservingConditions driver for TSOObsCon
//
...
namespace ASCOM.TSOObsCon.ObservingConditions
{
    ...
    //
    // Your driver's DeviceID is ASCOM.TSOObsCon.ObservingConditions
    //
    // The COM Guid attribute sets the CLSID for ASCOM.TSOObsCon.ObservingConditions
    // The COM ClassInterface/None attribute prevents an empty interface called _TSOObsCon from being created and used as the [default] interface
    //
    ...
    public class ObservingConditions : ReferenceCountedObjectBase, IObservingConditions, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TSOObsCon"/> class. Must be public to successfully register for COM.
        /// </summary>
        public ObservingConditions()
        {
            try
            {
                ...
                tl = new TraceLogger("", "TSOObsCon.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
