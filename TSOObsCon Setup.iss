...
; Generated by EoEquis on 11/12/2023 (UTC)
;
[Setup]
AppID={{abbb1e9c-7a73-4610-8ad4-4d299bc46f12}
AppName=ASCOM TSOObsCon ObservingConditions Driver
AppVerName=ASCOM TSOObsCon ObservingConditions Driver 1.0.0.1
AppVersion=1.0.0.1
...
OutputDir="."
OutputBaseFilename="TSOObsCon Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\ObservingConditions\TSOObsCon"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\ObservingConditions\TSOObsCon"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "G:\Dev\Git\TriStar Observing Conditions V2\bin\Release\ASCOM.TSOObsCon.exe"; DestDir: "{app}"
; TODO: Add driver assemblies into the ServedClasses folder
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "G:\Dev\Git\TriStar Observing Conditions V2\ReadMe.txt"; DestDir: "{app}"; Flags: isreadme
; TODO: Add other files needed by your driver here (add subfolders above)
Source: "G:\Dev\Git\TriStar Observing Conditions V2\bin\Release\Newtonsoft.Json.dll"; DestDir: "{app}"
Source: "G:\Dev\Git\TriStar Observing Conditions V2\bin\Release\Newtonsoft.Json.xml"; DestDir: "{app}"

; Only if driver is .NET
[Run]

; Only for .NET local-server drivers
Filename: "{app}\ASCOM.TSOObsCon.exe"; Parameters: "/regserver"
...
; Only for .NET local-server drivers
Filename: "{app}\ASCOM.TSOObsCon.exe"; Parameters: "/unregserver"
